...
export const GPU_SPECS: GpuSpec[] = [
  ...
  {
    id: 'w7900', name: 'Radeon PRO W7900', vendor: 'amd', arch: 'RDNA 3', node: 'TSMC 5nm/6nm',
    topology: 'monolithic',
    throughput: { fp64Vector: 1.92, fp64Ratio: 1 / 32, fp32: 61.32, fp16Dense: 122.6, int8Dense: 122.6 },
    memory: { capacityGB: 48, type: 'GDDR6', bandwidthGBs: 864 },
    computeUnits: 96, tdpW: 295, priceUSD: 3999,
    die: [
      { kind: 'compute-cluster', count: 8, areaWeight: 44, label: 'Compute Units (96 CUs)', mfmaIntegrated: true },
      { kind: 'l2', count: 1, areaWeight: 22, label: 'Infinity Cache (96 MB)' },
      { kind: 'memCtrl', count: 6, areaWeight: 10, label: 'GDDR6 Controllers (6 MCDs)' },
      { kind: 'gddr', count: 12, areaWeight: 16, label: 'GDDR6 (48 GB)' },
      { kind: 'interconnect', count: 1, areaWeight: 8, label: 'PCIe 4.0' },
    ],
  },
  {
    id: 'w7800', name: 'Radeon PRO W7800', vendor: 'amd', arch: 'RDNA 3', node: 'TSMC 5nm/6nm',
    topology: 'monolithic',
    throughput: { fp64Vector: 1.41, fp64Ratio: 1 / 32, fp32: 45.25, fp16Dense: 90.50, int8Dense: 90.50 },
    memory: { capacityGB: 32, type: 'GDDR6', bandwidthGBs: 576 },
    computeUnits: 70, tdpW: 260, priceUSD: 2499,
    die: [
      { kind: 'compute-cluster', count: 8, areaWeight: 42, label: 'Compute Units (70 CUs)', mfmaIntegrated: true },
      { kind: 'l2', count: 1, areaWeight: 20, label: 'Infinity Cache (64 MB)' },
      { kind: 'memCtrl', count: 4, areaWeight: 10, label: 'GDDR6 Controllers (4 MCDs)' },
      { kind: 'gddr', count: 8, areaWeight: 20, label: 'GDDR6 (32 GB)' },
      { kind: 'interconnect', count: 1, areaWeight: 8, label: 'PCIe 4.0' },
    ],
  },
  {
